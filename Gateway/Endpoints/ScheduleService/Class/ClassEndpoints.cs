...
public static class ClassEndpoints
{
    public static IEndpointRouteBuilder Map(this IEndpointRouteBuilder builder)
    {
        ...
        builder
            ...
            .Produces<string>(StatusCodes.Status404NotFound)
            .WithTags(classTag)
            .WithSummary("Get classes for day for teacher")
            .WithDescription("Get classes for day for teacher");
        ...
        builder
            ...
            .Produces<string>(StatusCodes.Status404NotFound)
            .WithTags(classTag)
            .WithSummary("Get classes for week for student")
            .WithDescription("Get classes for week for student");
