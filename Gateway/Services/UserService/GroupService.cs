...
public class GroupService : IGroupService
{
    ...
    {
        var grpcRequest = request.Adapt<UserServiceClient.TransferGroupsToNextSemesterRequest>();

        var result = await _groupService.TransferGroupsToNextSemesterAsync(grpcRequest);
